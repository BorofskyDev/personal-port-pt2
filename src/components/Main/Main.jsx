  ...
  return (
    <div className="Main" id="home">
      ...
      <div className="Main__container">
        ...
        <h6 className="Main__container-header__content">
          {" "}
          Front End Developer | 10+ Years Sales | 10+ Years Customer Service |
          10+ Years Client Management | 10+ Years Leadership | 8 Years Business
          Development | 8 Years Banking/Finance
        </h6>
        <h6 className="Main__container-header__content_bottom">
          I Develop More Than Websites and Apps
        </h6>
        <p className="Main__container-header2_bottom">I Develop Businesses</p>
        <div className="Main__container-button-box">
          <a className="Main__container-btn" href="#contact">
            {" "}
