        ...
        <div className="Projects__setting-text">
          <div className="Projects__setting-text_box">
            ...
            <p className="Projects__setting-text_box-content">
              ...
              onboard clients before a major launch. Helped create marketing
              language used in website. Designed the site first using Figma.
              Based on tutorial, customized for client's requests and vision.
            </p>
          </div>
          <div className="Projects__setting-text_box">
            <a href="https://corestrat.net" rel="noreferrer" target="_blank">
            ...
            <p className="Projects__setting-text_box-content">
              ...
              by me. Customer wanted to look for something that was modern, but
              also appealing and that stood out. Created CSS Design Library for
              the project.{" "}
            </p>
          </div>
        </div>
